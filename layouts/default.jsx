...
const DefaultLayout = ({ background, children, contentClass }) => {
  ...
  return (
    <div>
      ...
      <a
        id="github-btn"
        href="https://github.com/nguyentrisinh/demo-nextjs-animejs"
        target="black"
        className="fixed items-center p-2 bg-gray-300 rounded-full cursor-pointer hover:bg-gray-600 align-items-center cent bottom-2 right-2"
      >
        <svg
          className="w-10 h-10"
          version="1.1"
